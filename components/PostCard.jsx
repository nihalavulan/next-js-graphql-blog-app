  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
       <div className="relative overflow-hidde shadow-md pb-80 mb-6">
          <img src={post.featuredImage?.url} alt={post.title} className="object-to absolute h-80 w-full object-cover shadow-lg rounded-t-lg lg:rounded-lg"/>
       </div>
       ...
       <p className='text-center text-lg text-gray-700 font-nprmal px-4 lg:p-20 mb-8'>{post.excert}</p>
